...
// Foto ainda em processamento (TIMEOUT do OCR): NÃO é falha de leitura. O OCR pode
// terminar depois; como a foto vai com meta.wa, o webhook confirma sozinho quando ficar
// pronto. Por isso a copy é de "estou processando, te aviso aqui" (em destaque) e os
// atalhos são opcionais, para quem não quer esperar. NÃO culpar a foto aqui.
function msgProcessando(phone) {
  return '⏳ *Sua nota está sendo processada.*\n\n' +
    'A leitura entrou na fila e às vezes demora um pouco mais. Notas recém-emitidas, em contingência ou pendentes de autorização levam mais tempo para o sistema liberar os dados. É normal. ✅\n\n' +
    '*Pode deixar comigo, você não precisa fazer nada.* 🙌\n' +
    '*Assim que terminar, eu te aviso AQUI MESMO, automaticamente, com a confirmação da sua participação.* 🎯\n\n' +
    'Não precisa reenviar a foto nem repetir nada. 😉\n\n' +
    'Se preferir não esperar, escolha um atalho:\n' +
    '🔢 Digite os *44 números* da chave de acesso (ficam logo abaixo do QR code, na parte de baixo da nota)\n' +
