...
function msgProcessando(phone) {
  return '⚠️ *A qualidade da imagem e do QR code pode não estar boa.*\n\n' +
    ...
    '🔢 Digitar aqui no chat os *44 números* da chave de acesso (ficam na parte de baixo da nota, embaixo do QR code)\n' +
...
function msgFotoNaoLida(phone) {
  return '😕 *Não consegui ler o QR code dessa foto.*\n\n' +
    ...
    '🔢 Ou digite os *44 números* da chave de acesso (ficam logo abaixo do QR code)\n\n' +
