...
// OBS: a Meta limita o título do botão a 20 caracteres. Truncamos por segurança.
    ...
    interactive: {
      ...
      action: {
        buttons: buttons.map(function (b) {
          var titulo = String(b.title).substring(0, 20);
          return { type: 'reply', reply: { id: b.id, title: titulo } };
        })
      }
    }
  });
